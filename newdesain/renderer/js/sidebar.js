        ...
        <div class="header-brand">
          ...
          <nav class="header-nav">
            ...
            <a class="nav-item ${activePage === 'masterdata' || activePage === 'tkbm' ? 'active' : ''}" href="/masterdata?v=122">
              <i class="bi bi-database-fill"></i> Master Data <i class="bi bi-chevron-right float-end mt-1" style="font-size: 12px;"></i>
            </a>
            ...
            <a class="nav-item ${activePage.startsWith('setup') ? 'active' : ''}" href="/setup?v=122">
              <i class="bi bi-gear-fill"></i> Pengaturan <i class="bi bi-chevron-right float-end mt-1" style="font-size: 12px;"></i>
            </a>
