...
function checkDatabaseVersion() {
  ...
  // Jika database sudah ada dan versi aplikasi berubah
  if (fs.existsSync(dbPath)) {
    if (lastVersion && lastVersion !== currentVersion) {
      console.log(`[Main] Version changed from ${lastVersion} to ${currentVersion}. Backing up and resetting database...`);
      backupAndResetDatabase(dbDir, dbPath, lastVersion, currentVersion);
    }
  }
