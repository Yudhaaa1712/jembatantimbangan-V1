<?php
// modules/masterdata/supplier/hutang_ajax_new.php - Supplier Hutang Management API
...
try {
    ...
    switch ($action) {
        case 'update_hutang':
            ...
            $jumlah_bayar = filter_var($_POST['jumlah_bayar'] ?? 0, FILTER_VALIDATE_FLOAT);
        ...
        case 'get_supplier_hutang':
            $supplier_id = filter_var($_GET['supplier_id'] ?? 0, FILTER_VALIDATE_INT);
