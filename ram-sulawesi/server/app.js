...
// ─── Middleware ────────────────────────────────────────────────────────────────
// Batas bawaan Express 100kb terlalu kecil begitu logo struk ikut dikirim
// sebagai data URL di dalam JSON pengaturan.
...
// Print surat jalan pengiriman pabrik — versi ringkas lama, sudah tidak
// ditunjuk tombol mana pun. Dipertahankan sementara agar tautan lama tidak mati.
app.get('/surat-jalan/:id', isLoggedIn, (req, res) => res.sendFile(path.join(pagesDir, 'surat_jalan.html')));

// Print struk pengiriman pabrik — dipakai tombol Cetak di menu Pengiriman
app.get('/print-pengiriman/:id', isLoggedIn, (req, res) => res.sendFile(path.join(pagesDir, 'print_pengiriman.html')));
