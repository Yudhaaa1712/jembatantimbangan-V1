      ...
      <div class="header-top">
        <div class="header-brand">
          ...
          <nav class="header-nav">
            ...
            <a class="nav-item ${activePage === 'pembayaran' ? 'active' : ''}" href="/pembayaran?v=122"><svg class="icon" aria-hidden="true"><use href="#i-cash-stack"></use></svg> Pembayaran <span id="navBadgeBelumLunas" class="nav-badge" style="display:none;margin-left:auto;min-width:20px;border-radius:9999px;background:#ef4444;color:#fff;padding:2px 6px;text-align:center;font-size:10px;font-weight:700;line-height:1"></span></a>
