      ...
      case 'save_timbangan2': {
        ...
        try {
          ...
          if (totalAkhir > 0 && bayarSekarang) {
            ...
            const metodeLabel = isBeli && metodeBayarTiket ? ` (${metodeBayarTiket.toUpperCase()})` : '';
            const kasKeterangan = (`${actionLabel}${materialLabel} ${supirLabel}`.trim() || `${isBeli ? 'Pembelian' : 'Penjualan'} buah - ${tiketInfo?.no_tiket || 'N/A'}`) + metodeLabel;
