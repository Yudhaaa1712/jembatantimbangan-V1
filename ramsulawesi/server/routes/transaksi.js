    ...
    if (trx.id_pembayaran) {
      ...
      if (bayar && bayar.status === 'aktif') {
        return jsonResponse(res, false,
          `Tiket ini sudah dilunasi dalam pembayaran ke ${bayar.nama_supplier || 'supplier'} tanggal ${bayar.tanggal}. Batalkan pembayaran tersebut dulu di menu Pembayaran Supplier.`);
      }
    }
