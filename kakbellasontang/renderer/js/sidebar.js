          ...
          <nav class="header-nav">
            ...
            <div class="collapse ${activePage === 'masterdata' ? 'show' : ''}" id="masterdataSubmenu">
              <div class="ms-3 border-start ps-2 border-secondary">
                <a class="nav-item d-block ${activePage === 'masterdata' && window.location.search.includes('tab=kendaraan') ? 'active text-warning' : ''}" href="/masterdata?tab=kendaraan&v=122" style="font-size: 12px; padding: 6px 12px;"><i class="bi bi-truck-front-fill"></i> Data Tonase Ramp</a>
                ...
                <a class="nav-item d-block ${activePage === 'masterdata' && (!window.location.search || window.location.search.includes('tab=users')) && !window.location.search.includes('tab=kendaraan') && !window.location.search.includes('tab=supplier') && !window.location.search.includes('tab=supir') && !window.location.search.includes('tab=material') ? 'active text-warning' : ''}" href="/masterdata?tab=users&v=122" style="font-size: 12px; padding: 6px 12px;"><i class="bi bi-people-fill"></i> Pengguna</a>
