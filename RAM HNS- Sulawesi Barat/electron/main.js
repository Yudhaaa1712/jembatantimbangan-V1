...
function createWindow() {
  ...
  // Intercept external links but allow print ticket, struk pengiriman, surat jalan & riwayat hutang
  mainWindow.webContents.setWindowOpenHandler(({ url }) => {
    if (url.includes('/print-ticket') || url.includes('/print-pengiriman') || url.includes('/surat-jalan') || url.includes('/hutang-print')) {
        return { 
            action: 'allow',
